...
public class imageAdapter extends BaseAdapter implements SpinnerAdapter {
	...
	public imageAdapter(Context context, int h , int w) {
	...
	public Integer imgId[] = {
			R.drawable.attention_logo,
			R.drawable.speed_logo,
			R.drawable.visual_perception_logo,
			R.drawable.problem_solving_logo,
			R.drawable.memory_logo,
			R.drawable.flexibility_logo
	};
}
