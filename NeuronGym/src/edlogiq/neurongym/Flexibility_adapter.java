...
public class Flexibility_adapter extends BaseAdapter {

	private Context context;
	int imageBackground;
	int height , width;
	public Flexibility_adapter(Context context, int h , int w) {
	...
	public Integer imgId[] = {
			R.drawable.match_it_del,
			R.drawable.reversal_del,
			R.drawable.alpha_iq_logo,
			R.drawable.circle_match_logo
	};
}