...
public class Thirty_performance_history_activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		change = new Change_in_ani_calculator(30, this);
		try {
		...
		Days_and_games_played days_n_games = new Days_and_games_played(30, this);
